  ...
  <div className="w-full min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-[#e6f7f7] via-[#d0f0f0] to-[#b2eaea] px-4 py-8">
    ...
    <div className="mb-6 md:mb-10">
      <img
        src="/fishman.png"
        alt="Fishman Logo"
        className="h-110 md:h-100 object-contain transition-transform duration-300 hover:scale-105"
      />
    </div>

    {/* Login Box Section */}
    <div className="w-full mt-[-200px] mb-[100px] max-w-md bg-white bg-opacity-95 p-6 md:p-8 rounded-3xl shadow-2xl">
